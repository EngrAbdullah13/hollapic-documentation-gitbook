# Workspace and Credit Problems

Use this page when an invitation, workspace, credit balance, or payment does not look right.
...
Limited allocations can reserve credits for collaborators. Review pending and active limited-access assignments on the Invite Team page.

## A collaborator sees fewer credits than the owner

This is expected with Limited Credit Access. The collaborator sees only their remaining allowance.

## Credits did not update after purchase

### Try this

1. Refresh Hollapic.
2. Confirm you are signed in with the purchasing email.
3. Check the payment confirmation.
4. Wait a few moments and check again.
5. Contact support when payment succeeded but the balance remains unchanged.

## Subscription credits did not appear
