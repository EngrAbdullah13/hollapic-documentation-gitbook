# Use and Edit Brand DNA

Use Brand DNA when you want new images to follow your saved brand direction.

## Use Brand DNA in Studio

1. Open Studio.
2. Choose your workflow and upload the required images.
3. Turn on **Use Brand DNA** when the option is available.
4. Add instructions for the current image.
...
Future generations use the updated information. Images you created earlier do not change.
